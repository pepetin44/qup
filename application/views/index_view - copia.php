        ...
        function(){
          ...
          $.ajax({
                ...
                success: function(data){
                    if(data.response == 'Hola'){
                      //console.log('data.response------');
                               $('<label>Tu usuario ha sido creado exitosamente, por favor activa tu cuenta através del e-mail que ha sido enviado a tu cuenta de correo electronico. Para poder anunciarte y publicar anuncios, deberás registrar tu información completa. Esto lo podrás hacer en cualquier momento entrando a tu perfil.</label>').appendTo('#confirm');
...
<!--<div id='contenedor_total_registros'  class='contenedor_total_registros'>--> <!-- Contenedeor total  -->
