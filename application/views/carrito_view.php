...
if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1){
  ...
  document.write('<link type="text/css" rel="stylesheet" href="<?=base_url()?>css/general.css" media="screen"></link> <link type="text/css" rel="stylesheet" href="<?=base_url()?>css/venta.css" media="screen"></link></link> ');
  }
  </script>
  ...
  <link type="text/css" rel="stylesheet" href="<?=base_url()?>css/carrito.css" media="screen"></link>
<script>
 jQuery(document).ready(
	 ...
	 $(".cantidad").change(
               function(){
                   ...
                   $.ajax({
                       url      : '<?=base_url()?>usuario/cuenta/carritoUpdate',
                       type     : 'POST',
                       dataType : 'json',
                       data : 'rowID=' + rowID + '&qty=' + cantidad,
...
<img src="<?=base_url()?>images/cerrar_verde.png" />
...
<tr>
<td>
<img src="<?=base_url()?>images/productos/01.png" width="184" height="158"/>
</td>
<td>
<font> Shampoo </font>
</br>
...
<tr>
<td>
    <img class="borde_producto" src="<?=base_url()?>images/productos/01.png" width="47" height="41"/>
</td>
<td>
<?php echo $items['name']; ?>
...
<td><input type="number" class="cantidad" value="<?=$items['qty']?>" name="<?=$i.'[qty]'?>" id="<?=$items['rowid']?>">
</td>
<td>
<img src="<?=base_url()?>images/eliminar.png"/>
     </td>
</tr>
<?php $i++; ?>
<?php endforeach;
/*endif; */?>
  ...
  <div class="total_productos">
     <div class="contenedor_total_productos" > SUBTOTAL <input type="text"  name="subtotal" class="total_solo_productos" value="<?php echo $subtotal = $this->cart->format_number($this->cart->total()); ?>"/></div>
      <div class="contenedor_total_productos" > TOTAL <input type="text"  name="subtotal" class="total_solo_productos" value="<?php echo $total = $subtotal; ?>"/></div>
      </div>
      </br>
      </br>
...
<div class="cupones_productos">
   <a> Datos de envio </a> Datos de envio grardados <select> <option> ---</option> <option> 1 </option>
</div>
</br>
Nombre: <input type="text" /> &nbsp;&nbsp;&nbsp; Apellidos: <input type="text" />
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.P: <input style="margin-left:32px;" type="text" /> 
</br> 
</br>
 Calle: <input style=" margin-left:22px;" type="text" /> &nbsp;&nbsp;&nbsp; Número: <input type="text" style="margin-left:10px;"/>
 &nbsp;&nbsp;&nbsp;&nbsp; Colonia: <input type="text"/> 
 </br>
 </br>
 Ciudad: <input type="text" style=" margin-left:5px;"/>
&nbsp;&nbsp;&nbsp; Estado: <select style="margin-left:20px;"> 
 <option> --- </option>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 Pais: <select style="margin-left:30px;">
        <option> ---- </option>
